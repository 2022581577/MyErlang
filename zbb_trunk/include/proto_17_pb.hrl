...
-ifndef(C2S17000_PB_H).
-define(C2S17000_PB_H, true).
-record(c2s17000, {
    grow_type = erlang:error({required, grow_type})
}).
-endif.

-ifndef(S2C17000_PB_H).
-define(S2C17000_PB_H, true).
-record(s2c17000, {
    list = []
}).
-endif.

-ifndef(S2C17001_PB_H).
-define(S2C17001_PB_H, true).
-record(s2c17001, {
    grow_info = erlang:error({required, grow_info})
}).
-endif.

-ifndef(C2S17002_PB_H).
-define(C2S17002_PB_H, true).
-record(c2s17002, {
    grow_type = erlang:error({required, grow_type}),
...
-ifndef(S2C17002_PB_H).
-define(S2C17002_PB_H, true).
-record(s2c17002, {
    grow_type = erlang:error({required, grow_type}),
...
-ifndef(C2S17003_PB_H).
-define(C2S17003_PB_H, true).
-record(c2s17003, {
    grow_type = erlang:error({required, grow_type}),
    select_image = erlang:error({required, select_image})
}).
...
-ifndef(S2C17003_PB_H).
-define(S2C17003_PB_H, true).
-record(s2c17003, {
    grow_type = erlang:error({required, grow_type}),
    select_image = erlang:error({required, select_image})
}).
...
-ifndef(C2S17004_PB_H).
-define(C2S17004_PB_H, true).
-record(c2s17004, {
    grow_type = erlang:error({required, grow_type}),
    is_show = erlang:error({required, is_show})
}).
...
-ifndef(S2C17004_PB_H).
-define(S2C17004_PB_H, true).
-record(s2c17004, {
    grow_type = erlang:error({required, grow_type}),
    is_show = erlang:error({required, is_show})
}).
