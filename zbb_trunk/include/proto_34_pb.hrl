...
-ifndef(S2C34000_PB_H).
-define(S2C34000_PB_H, true).
-record(s2c34000, {
    main_activities = [],
    award_activities = []
}).
...
-ifndef(STRUCT_MAIN_ACTIVITY_PB_H).
-define(STRUCT_MAIN_ACTIVITY_PB_H, true).
-record(struct_main_activity, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    start_time = erlang:error({required, start_time}),
    stop_time = erlang:error({required, stop_time})
}).
-endif.

-ifndef(STRUCT_AWARD_ACTIVITY_PB_H).
-define(STRUCT_AWARD_ACTIVITY_PB_H, true).
-record(struct_award_activity, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
    start_time = erlang:error({required, start_time}),
    stop_time = erlang:error({required, stop_time}),
    balance_time = erlang:error({required, balance_time})
}).
-endif.

-ifndef(C2S34001_PB_H).
-define(C2S34001_PB_H, true).
-record(c2s34001, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype})
...
-ifndef(S2C34001_PB_H).
-define(S2C34001_PB_H, true).
-record(s2c34001, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
...
-ifndef(STRUCT_CONDITION_PB_H).
-define(STRUCT_CONDITION_PB_H, true).
-record(struct_condition, {
    nth = erlang:error({required, nth}),
    is_award = erlang:error({required, is_award}),
    event_targets = []
}).
-endif.

-ifndef(STRUCT_EVENT_TARGET_PB_H).
-define(STRUCT_EVENT_TARGET_PB_H, true).
-record(struct_event_target, {
...
-ifndef(C2S34002_PB_H).
-define(C2S34002_PB_H, true).
-record(c2s34002, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
...
-ifndef(S2C34003_PB_H).
-define(S2C34003_PB_H, true).
-record(s2c34003, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
...
-ifndef(S2C34004_PB_H).
-define(S2C34004_PB_H, true).
-record(s2c34004, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
    is_buy = erlang:error({required, is_buy}),
    buy_time = erlang:error({required, buy_time}),
    lists = []
}).
-endif.

-ifndef(C2S34005_PB_H).
-define(C2S34005_PB_H, true).
-record(c2s34005, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype})
...
-ifndef(C2S34006_PB_H).
-define(C2S34006_PB_H, true).
-record(c2s34006, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
...
-ifndef(S2C34007_PB_H).
-define(S2C34007_PB_H, true).
-record(s2c34007, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
...
-ifndef(S2C34008_PB_H).
-define(S2C34008_PB_H, true).
-record(s2c34008, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype})
...
-ifndef(S2C34009_PB_H).
-define(S2C34009_PB_H, true).
-record(s2c34009, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
...
-ifndef(S2C34010_PB_H).
-define(S2C34010_PB_H, true).
-record(s2c34010, {
    activity_id = erlang:error({required, activity_id}),
    type = erlang:error({required, type}),
    subtype = erlang:error({required, subtype}),
