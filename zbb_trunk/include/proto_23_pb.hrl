...
-ifndef(C2S23001_PB_H).
-define(C2S23001_PB_H, true).
-record(c2s23001, {
    
}).
-endif.

-ifndef(S2C23001_PB_H).
-define(S2C23001_PB_H, true).
-record(s2c23001, {
    rank = erlang:error({required, rank}),
    list = [],
    best_rank = erlang:error({required, best_rank})
}).
-endif.

-ifndef(AWARD_PB_H).
-define(AWARD_PB_H, true).
-record(award, {
    rank = erlang:error({required, rank}),
    user_lv = erlang:error({required, user_lv})
}).
-endif.

-ifndef(C2S23002_PB_H).
-define(C2S23002_PB_H, true).
-record(c2s23002, {
    
}).
-endif.

-ifndef(S2C23002_PB_H).
-define(S2C23002_PB_H, true).
-record(s2c23002, {
    list = []
}).
-endif.

-ifndef(TAR_INFO_PB_H).
-define(TAR_INFO_PB_H, true).
-record(tar_info, {
...
-ifndef(C2S23003_PB_H).
-define(C2S23003_PB_H, true).
-record(c2s23003, {
    
}).
-endif.

-ifndef(C2S23004_PB_H).
-define(C2S23004_PB_H, true).
-record(c2s23004, {
    order = erlang:error({required, order}),
    tar_id = erlang:error({required, tar_id}),
    type = erlang:error({required, type})
}).
-endif.

-ifndef(C2S23005_PB_H).
-define(C2S23005_PB_H, true).
-record(c2s23005, {
    
}).
-endif.

-ifndef(S2C23006_PB_H).
-define(S2C23006_PB_H, true).
-record(s2c23006, {
    code = erlang:error({required, code})
}).
-endif.

-ifndef(C2S23007_PB_H).
-define(C2S23007_PB_H, true).
-record(c2s23007, {
    
}).
-endif.

-ifndef(C2S23008_PB_H).
-define(C2S23008_PB_H, true).
-record(c2s23008, {
    
}).
-endif.

-ifndef(S2C23008_PB_H).
-define(S2C23008_PB_H, true).
-record(s2c23008, {
    list = []
}).
-endif.
...
-ifndef(LOG_PB_H).
-define(LOG_PB_H, true).
-record(log, {
    aer = erlang:error({required, aer}),
    der = erlang:error({required, der}),
    aer_rank = erlang:error({required, aer_rank}),
    der_rank = erlang:error({required, der_rank}),
    result = erlang:error({required, result}),
    time = erlang:error({required, time})
}).
-endif.

-ifndef(S2C23009_PB_H).
-define(S2C23009_PB_H, true).
-record(s2c23009, {
    new = erlang:error({required, new}),
    old = erlang:error({required, old})
}).
-endif.

-ifndef(S2C23010_PB_H).
-define(S2C23010_PB_H, true).
-record(s2c23010, {
    result = erlang:error({required, result}),
    rank = erlang:error({required, rank}),
    old_rank = erlang:error({required, old_rank}),
    tar_rank = erlang:error({required, tar_rank})
}).
-endif.

-ifndef(S2C23011_PB_H).
-define(S2C23011_PB_H, true).
-record(s2c23011, {
    
}).
-endif.

-ifndef(C2S23012_PB_H).
-define(C2S23012_PB_H, true).
-record(c2s23012, {
    list = []
}).
-endif.

-ifndef(S2C23012_PB_H).
-define(S2C23012_PB_H, true).
-record(s2c23012, {
    list = []
}).
-endif.

-ifndef(S2C23013_PB_H).
-define(S2C23013_PB_H, true).
-record(s2c23013, {
    pos = erlang:error({required, pos})
}).
-endif.

-ifndef(C2S23014_PB_H).
-define(C2S23014_PB_H, true).
-record(c2s23014, {
    
}).
-endif.

-ifndef(S2C23014_PB_H).
-define(S2C23014_PB_H, true).
-record(s2c23014, {
    list = []
}).
-endif.

-ifndef(P_LEGEND_PB_H).
-define(P_LEGEND_PB_H, true).
-record(p_legend, {
    pos = erlang:error({required, pos}),
    boss_lv = erlang:error({required, boss_lv}),
    user_id = erlang:error({required, user_id}),
    user = erlang:error({required, user})
}).
-endif.

-ifndef(C2S23015_PB_H).
-define(C2S23015_PB_H, true).
-record(c2s23015, {
    pos = erlang:error({required, pos}),
...
-ifndef(C2S23016_PB_H).
-define(C2S23016_PB_H, true).
-record(c2s23016, {
    
}).
-endif.

-ifndef(S2C23017_PB_H).
-define(S2C23017_PB_H, true).
-record(s2c23017, {
    result = erlang:error({required, result})
}).
-endif.
