...
-ifndef(S2C19001_PB_H).
-define(S2C19001_PB_H, true).
-record(s2c19001, {
    list = []
}).
-endif.

-ifndef(C2S19002_PB_H).
-define(C2S19002_PB_H, true).
-record(c2s19002, {
...
-ifndef(S2C19002_PB_H).
-define(S2C19002_PB_H, true).
-record(s2c19002, {
    page = erlang:error({required, page}),
    num = erlang:error({required, num}),
    list = []
...
-record(mail_info, {
    ...
    sender = erlang:error({required, sender}),
    sender_name = erlang:error({required, sender_name}),
    send_time = erlang:error({required, send_time}),
    type = erlang:error({required, type}),
    state = erlang:error({required, state}),
    lock = erlang:error({required, lock}),
    attachment = erlang:error({required, attachment}),
    title = erlang:error({required, title}),
    read_time = erlang:error({required, read_time})
}).
-endif.

-ifndef(C2S19003_PB_H).
-define(C2S19003_PB_H, true).
-record(c2s19003, {
    id = erlang:error({required, id})
}).
-endif.

-ifndef(S2C19003_PB_H).
-define(S2C19003_PB_H, true).
-record(s2c19003, {
    id = erlang:error({required, id}),
    sender = erlang:error({required, sender}),
    sender_name = erlang:error({required, sender_name}),
    ...
    is_geted = erlang:error({required, is_geted}),
    attachment = [],
    read_time = erlang:error({required, read_time})
}).
-endif.

-ifndef(C2S19004_PB_H).
-define(C2S19004_PB_H, true).
-record(c2s19004, {
    list = []
}).
-endif.

-ifndef(S2C19004_PB_H).
-define(S2C19004_PB_H, true).
-record(s2c19004, {
    list = []
}).
-endif.

-ifndef(S2C19005_PB_H).
-define(S2C19005_PB_H, true).
-record(s2c19005, {
    code = erlang:error({required, code})
}).
-endif.

-ifndef(C2S19006_PB_H).
-define(C2S19006_PB_H, true).
-record(c2s19006, {
    tar_list = [],
    title = erlang:error({required, title}),
    content = erlang:error({required, content}),
...
-ifndef(C2S19007_PB_H).
-define(C2S19007_PB_H, true).
-record(c2s19007, {
    id = erlang:error({required, id}),
    state = erlang:error({required, state})
}).
...
-ifndef(C2S19008_PB_H).
-define(C2S19008_PB_H, true).
-record(c2s19008, {
    id = erlang:error({required, id})
}).
-endif.
