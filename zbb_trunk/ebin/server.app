{application,server,
             [{description,"game_server"},
              ...
              {modules,[a_star,binary_heap,circle,common_pb,csv_parser,db,
                        ...
                        line2d,logger_h,loglevel,main,math_util,mmake,
                        mod_reader,mod_user,mtop,mysql,mysql_auth,mysql_conn,
                        mysql_recv,navmesh,navmesh_test,node_interface,
                        ...
                        proto_35_pb,proto_60_pb,rebar_file_utils,rebar_utils,
                        rectangle,rfc4627,rfc4627_jsonrpc,rfc4627_jsonrpc_app,
                        ...
                        smdl,srv_timer,sys_info,tcp_acceptor,tcp_acceptor_sup,
                        tcp_client_sup,tcp_listener,tcp_listener_sup,triangle,
