{application,server,
             [{description,"game_server"},
              ...
              {modules,[a_star,binary_heap,circle,client_protobuf_encode,
                        common_pb,counter,cron,cron_lib,cron_test,csv_parser,
                        data_map,delaunay,dynamic_compile,dynarec,edb,
                        ...
                        error_logger_lager_h,ets_init,fsm_lock,game_config,
                        game_counter,game_ctl,game_ets_init,game_gen_server,
                        game_geom_astar,game_geom_bstar,game_mmdb,
                        game_mmdb_preload,game_node_interface,game_pack_send,
                        game_reloader,gbk_to_unicode,global_data_disk,
