...
-ifndef(C2S29000_PB_H).
-define(C2S29000_PB_H, true).
-record(c2s29000, {
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(S2C29000_PB_H).
-define(S2C29000_PB_H, true).
-record(s2c29000, {
    code = erlang:error({required, code})
}).
-endif.

-ifndef(S2C29001_PB_H).
-define(S2C29001_PB_H, true).
-record(s2c29001, {
    user = erlang:error({required, user})
}).
-endif.

-ifndef(C2S29002_PB_H).
-define(C2S29002_PB_H, true).
-record(c2s29002, {
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(C2S29003_PB_H).
-define(C2S29003_PB_H, true).
-record(c2s29003, {
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(C2S29004_PB_H).
-define(C2S29004_PB_H, true).
-record(c2s29004, {
    rela_type = erlang:error({required, rela_type}),
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(C2S29005_PB_H).
-define(C2S29005_PB_H, true).
-record(c2s29005, {
    rela_type = erlang:error({required, rela_type})
}).
-endif.

-ifndef(S2C29005_PB_H).
-define(S2C29005_PB_H, true).
-record(s2c29005, {
    rela_type = erlang:error({required, rela_type}),
    list = [],
    deletes = []
...
-ifndef(P_RELA_PB_H).
-define(P_RELA_PB_H, true).
-record(p_rela, {
    user = erlang:error({required, user}),
    last_chat_time = erlang:error({required, last_chat_time})
}).
-endif.

-ifndef(C2S29006_PB_H).
-define(C2S29006_PB_H, true).
-record(c2s29006, {
    server_no = erlang:error({required, server_no}),
    nick_name = erlang:error({required, nick_name})
}).
...
-ifndef(S2C29006_PB_H).
-define(S2C29006_PB_H, true).
-record(s2c29006, {
    user = erlang:error({required, user})
}).
-endif.
