...
-ifndef(S2C24000_PB_H).
-define(S2C24000_PB_H, true).
-record(s2c24000, {
    color = erlang:error({required, color}),
    insure_num = erlang:error({required, insure_num}),
    rob_num = erlang:error({required, rob_num}),
    nfc_num = erlang:error({required, nfc_num}),
    start_time = erlang:error({required, start_time}),
    is_finish = erlang:error({required, is_finish})
}).
-endif.

-ifndef(C2S24001_PB_H).
-define(C2S24001_PB_H, true).
-record(c2s24001, {
    
}).
-endif.

-ifndef(S2C24001_PB_H).
-define(S2C24001_PB_H, true).
-record(s2c24001, {
    color = erlang:error({required, color}),
    accept_num = erlang:error({required, accept_num}),
    rob_num = erlang:error({required, rob_num}),
    refresh_free_num = erlang:error({required, refresh_free_num}),
    seek_help_time = erlang:error({required, seek_help_time}),
    start_time = erlang:error({required, start_time})
}).
-endif.

-ifndef(C2S24002_PB_H).
-define(C2S24002_PB_H, true).
-record(c2s24002, {
    is_one_key = erlang:error({required, is_one_key})
}).
-endif.

-ifndef(S2C24002_PB_H).
-define(S2C24002_PB_H, true).
-record(s2c24002, {
    color = erlang:error({required, color}),
    list = []
}).
...
-ifndef(C2S24003_PB_H).
-define(C2S24003_PB_H, true).
-record(c2s24003, {
    insure_num = erlang:error({required, insure_num})
}).
-endif.

-ifndef(C2S24004_PB_H).
-define(C2S24004_PB_H, true).
-record(c2s24004, {
    
}).
-endif.

-ifndef(S2C24004_PB_H).
-define(S2C24004_PB_H, true).
-record(s2c24004, {
    list = []
}).
-endif.

-ifndef(C2S24005_PB_H).
-define(C2S24005_PB_H, true).
-record(c2s24005, {
    
}).
-endif.

-ifndef(S2C24005_PB_H).
-define(S2C24005_PB_H, true).
-record(s2c24005, {
...
-ifndef(C2S24006_PB_H).
-define(C2S24006_PB_H, true).
-record(c2s24006, {
    
}).
-endif.

-ifndef(C2S24007_PB_H).
-define(C2S24007_PB_H, true).
-record(c2s24007, {
    
}).
-endif.

-ifndef(S2C24007_PB_H).
-define(S2C24007_PB_H, true).
-record(s2c24007, {
...
-ifndef(S2C24008_PB_H).
-define(S2C24008_PB_H, true).
-record(s2c24008, {
    type = erlang:error({required, type}),
    my_name = erlang:error({required, my_name}),
    my_guild_name = erlang:error({required, my_guild_name}),
    tar_name = erlang:error({required, tar_name}),
    tar_guild_name = erlang:error({required, tar_guild_name})
}).
-endif.

-ifndef(S2C24009_PB_H).
-define(S2C24009_PB_H, true).
-record(s2c24009, {
