...
-ifndef(C2S28000_PB_H).
-define(C2S28000_PB_H, true).
-record(c2s28000, {
    
}).
-endif.

-ifndef(S2C28000_PB_H).
-define(S2C28000_PB_H, true).
-record(s2c28000, {
    team_id = erlang:error({required, team_id}),
    auto_allow = erlang:error({required, auto_allow}),
    member_invite = erlang:error({required, member_invite})
}).
-endif.

-ifndef(S2C28001_PB_H).
-define(S2C28001_PB_H, true).
-record(s2c28001, {
    list = []
}).
-endif.

-ifndef(P_MEMBER_PB_H).
-define(P_MEMBER_PB_H, true).
-record(p_member, {
    user = erlang:error({required, user}),
    is_leader = erlang:error({required, is_leader}),
    map_tpl_id = erlang:error({required, map_tpl_id}),
    map_line = erlang:error({required, map_line})
}).
-endif.

-ifndef(C2S28002_PB_H).
-define(C2S28002_PB_H, true).
-record(c2s28002, {
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(S2C28002_PB_H).
-define(S2C28002_PB_H, true).
-record(s2c28002, {
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(S2C28003_PB_H).
-define(S2C28003_PB_H, true).
-record(s2c28003, {
    team_id = erlang:error({required, team_id}),
    user = erlang:error({required, user})
}).
...
-ifndef(C2S28004_PB_H).
-define(C2S28004_PB_H, true).
-record(c2s28004, {
    team_id = erlang:error({required, team_id})
}).
-endif.

-ifndef(C2S28005_PB_H).
-define(C2S28005_PB_H, true).
-record(c2s28005, {
    
}).
-endif.

-ifndef(S2C28005_PB_H).
-define(S2C28005_PB_H, true).
-record(s2c28005, {
    list = []
}).
-endif.
...
-ifndef(C2S28006_PB_H).
-define(C2S28006_PB_H, true).
-record(c2s28006, {
    leader_id = erlang:error({required, leader_id})
}).
-endif.

-ifndef(S2C28006_PB_H).
-define(S2C28006_PB_H, true).
-record(s2c28006, {
    leader_id = erlang:error({required, leader_id})
}).
-endif.

-ifndef(S2C28007_PB_H).
-define(S2C28007_PB_H, true).
-record(s2c28007, {
    tar = erlang:error({required, tar})
}).
-endif.

-ifndef(C2S28008_PB_H).
-define(C2S28008_PB_H, true).
-record(c2s28008, {
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(C2S28009_PB_H).
-define(C2S28009_PB_H, true).
-record(c2s28009, {
    
}).
-endif.

-ifndef(C2S28010_PB_H).
-define(C2S28010_PB_H, true).
-record(c2s28010, {
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(C2S28011_PB_H).
-define(C2S28011_PB_H, true).
-record(c2s28011, {
    tar_id = erlang:error({required, tar_id})
}).
-endif.

-ifndef(C2S28012_PB_H).
-define(C2S28012_PB_H, true).
-record(c2s28012, {
    auto_allow = erlang:error({required, auto_allow}),
    member_invite = erlang:error({required, member_invite})
}).
...
-ifndef(S2C28013_PB_H).
-define(S2C28013_PB_H, true).
-record(s2c28013, {
    user_id = erlang:error({required, user_id}),
...
-ifndef(S2C28014_PB_H).
-define(S2C28014_PB_H, true).
-record(s2c28014, {
    code = erlang:error({required, code})
}).
-endif.

-ifndef(C2S28015_PB_H).
-define(C2S28015_PB_H, true).
-record(c2s28015, {
