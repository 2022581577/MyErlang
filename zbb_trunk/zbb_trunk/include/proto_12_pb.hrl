...
-ifndef(C2S12001_PB_H).
-define(C2S12001_PB_H, true).
-record(c2s12001, {
    current_pos = erlang:error({required, current_pos}),
    list = []
}).
-endif.

-ifndef(S2C12001_PB_H).
-define(S2C12001_PB_H, true).
-record(s2c12001, {
    user_id = erlang:error({required, user_id}),
    current_pos = erlang:error({required, current_pos}),
    list = []
...
-ifndef(C2S12002_PB_H).
-define(C2S12002_PB_H, true).
-record(c2s12002, {
    
}).
-endif.

-ifndef(S2C12002_PB_H).
-define(S2C12002_PB_H, true).
-record(s2c12002, {
    result = erlang:error({required, result})
}).
-endif.

-ifndef(S2C12003_PB_H).
-define(S2C12003_PB_H, true).
-record(s2c12003, {
    list = []
}).
-endif.

-ifndef(S2C12004_PB_H).
-define(S2C12004_PB_H, true).
-record(s2c12004, {
    list = []
}).
-endif.

-ifndef(C2S12005_PB_H).
-define(C2S12005_PB_H, true).
-record(c2s12005, {
    door_inst_id = erlang:error({required, door_inst_id})
}).
-endif.

-ifndef(S2C12005_PB_H).
-define(S2C12005_PB_H, true).
-record(s2c12005, {
    map_tpl_id = erlang:error({required, map_tpl_id}),
    pos_x = erlang:error({required, pos_x}),
    pos_y = erlang:error({required, pos_y}),
...
-ifndef(C2S12006_PB_H).
-define(C2S12006_PB_H, true).
-record(c2s12006, {
    pos_x = erlang:error({required, pos_x}),
    pos_y = erlang:error({required, pos_y})
}).
...
-ifndef(S2C12006_PB_H).
-define(S2C12006_PB_H, true).
-record(s2c12006, {
    pos_x = erlang:error({required, pos_x}),
    pos_y = erlang:error({required, pos_y}),
    result = 0
...
-ifndef(S2C12007_PB_H).
-define(S2C12007_PB_H, true).
-record(s2c12007, {
    list = []
}).
-endif.

-ifndef(S2C12008_PB_H).
-define(S2C12008_PB_H, true).
-record(s2c12008, {
    list = [],
    type = 0
}).
...
-ifndef(C2S12009_PB_H).
-define(C2S12009_PB_H, true).
-record(c2s12009, {
    target_map_id = erlang:error({required, target_map_id}),
...
-ifndef(S2C12009_PB_H).
-define(S2C12009_PB_H, true).
-record(s2c12009, {
    result = erlang:error({required, result})
}).
-endif.

-ifndef(C2S12010_PB_H).
-define(C2S12010_PB_H, true).
-record(c2s12010, {
    tpl_id = erlang:error({required, tpl_id}),
    inst_id = erlang:error({required, inst_id})
}).
-endif.

-ifndef(S2C12011_PB_H).
-define(S2C12011_PB_H, true).
-record(s2c12011, {
...
-ifndef(S2C12012_PB_H).
-define(S2C12012_PB_H, true).
-record(s2c12012, {
    list = []
}).
-endif.

-ifndef(S2C12013_PB_H).
-define(S2C12013_PB_H, true).
-record(s2c12013, {
    list = []
}).
-endif.

-ifndef(INDEX_ITEM_PB_H).
-define(INDEX_ITEM_PB_H, true).
-record(index_item, {
...
-ifndef(C2S12014_PB_H).
-define(C2S12014_PB_H, true).
-record(c2s12014, {
    list = []
}).
-endif.

-ifndef(S2C12014_PB_H).
-define(S2C12014_PB_H, true).
-record(s2c12014, {
    drop_group_id = erlang:error({required, drop_group_id}),
    index_list = [],
    pickup_id = erlang:error({required, pickup_id})
}).
-endif.

-ifndef(MAP_MON_DROP_PB_H).
-define(MAP_MON_DROP_PB_H, true).
-record(map_mon_drop, {
    drop_group_id = erlang:error({required, drop_group_id}),
    from_id = erlang:error({required, from_id}),
    from_type = erlang:error({required, from_type}),
    pos_x = erlang:error({required, pos_x}),
    pos_y = erlang:error({required, pos_y}),
    own_id = erlang:error({required, own_id}),
    own_time = erlang:error({required, own_time}),
    expire_time = erlang:error({required, expire_time}),
    expire_frame = erlang:error({required, expire_frame}),
    team_id = erlang:error({required, team_id}),
    drop_list = []
}).
-endif.

-ifndef(DROP_DETAIL_PB_H).
-define(DROP_DETAIL_PB_H, true).
-record(drop_detail, {
    index = erlang:error({required, index}),
    item_tpl_id = erlang:error({required, item_tpl_id}),
    drop_id = erlang:error({required, drop_id}),
    item_num = erlang:error({required, item_num})
}).
-endif.

-ifndef(S2C12015_PB_H).
-define(S2C12015_PB_H, true).
-record(s2c12015, {
    user_id = erlang:error({required, user_id}),
    hp = erlang:error({required, hp}),
    recover_hp = erlang:error({required, recover_hp}),
    type = 0
}).
-endif.

-ifndef(C2S12016_PB_H).
-define(C2S12016_PB_H, true).
-record(c2s12016, {
    line = erlang:error({required, line}),
    pos_x = erlang:error({required, pos_x}),
    pos_y = erlang:error({required, pos_y})
}).
-endif.

-ifndef(S2C12016_PB_H).
-define(S2C12016_PB_H, true).
-record(s2c12016, {
    line = erlang:error({required, line})
}).
-endif.

-ifndef(C2S12017_PB_H).
-define(C2S12017_PB_H, true).
-record(c2s12017, {
    map_tpl_id = erlang:error({required, map_tpl_id})
}).
-endif.

-ifndef(S2C12018_PB_H).
-define(S2C12018_PB_H, true).
-record(s2c12018, {
    next_refresh_elite_time = 0,
    next_refresh_globin_time = 0,
    current_wave = 0,
    total_wave = 0
}).
-endif.

-ifndef(S2C12003_MAP_USER_PB_H).
-define(S2C12003_MAP_USER_PB_H, true).
-record(s2c12003_map_user, {
    user_id = erlang:error({required, user_id}),
...
-ifndef(S2C12007_MAP_MON_PB_H).
-define(S2C12007_MAP_MON_PB_H, true).
-record(s2c12007_map_mon, {
    ...
    speed = erlang:error({required, speed}),
    misc_info = [],
    host_id = erlang:error({required, host_id}),
...
-ifndef(C2S12014_DROP_GROUP_PB_H).
-define(C2S12014_DROP_GROUP_PB_H, true).
-record(c2s12014_drop_group, {
    drop_group_id = erlang:error({required, drop_group_id}),
    index_list = []
}).
-endif.
