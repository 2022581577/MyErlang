...
-ifndef(C2S14001_PB_H).
-define(C2S14001_PB_H, true).
-record(c2s14001, {
...
-ifndef(S2C14001_PB_H).
-define(S2C14001_PB_H, true).
-record(s2c14001, {
    skill_id = erlang:error({required, skill_id}),
...
-ifndef(MAP_ACTOR_BATTLE_PB_H).
-define(MAP_ACTOR_BATTLE_PB_H, true).
-record(map_actor_battle, {
    id = erlang:error({required, id}),
    type = erlang:error({required, type}),
    hp = erlang:error({required, hp}),
    effect_hp = erlang:error({required, effect_hp}),
    attack_steal = 0,
    attack_rebound = 0,
    bak = 0,
    x = 0,
    ...
    mod_buff_list = [],
    del_buff_list = [],
    old_x = erlang:error({required, old_x}),
    old_y = erlang:error({required, old_y}),
    is_clear_path = erlang:error({required, is_clear_path}),
    speed = 0
}).
-endif.

-ifndef(MAP_TARGET_BATTLE_PB_H).
-define(MAP_TARGET_BATTLE_PB_H, true).
-record(map_target_battle, {
    id = erlang:error({required, id}),
    type = erlang:error({required, type}),
    hp = erlang:error({required, hp}),
    effect_hp = erlang:error({required, effect_hp}),
...
-ifndef(S2C14002_PB_H).
-define(S2C14002_PB_H, true).
-record(s2c14002, {
    skill_id = erlang:error({required, skill_id}),
...
-ifndef(S2C14003_PB_H).
-define(S2C14003_PB_H, true).
-record(s2c14003, {
    state = erlang:error({required, state}),
    pve_state = erlang:error({required, pve_state})
}).
-endif.

-ifndef(S2C14004_PB_H).
-define(S2C14004_PB_H, true).
-record(s2c14004, {
    attr = []
}).
-endif.

-ifndef(S2C14004_ATTR_ID_VALUE_PB_H).
-define(S2C14004_ATTR_ID_VALUE_PB_H, true).
-record(s2c14004_attr_id_value, {
    attr_id = erlang:error({required, attr_id}),
    attr_value = erlang:error({required, attr_value})
}).
-endif.
