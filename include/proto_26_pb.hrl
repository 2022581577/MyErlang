...
-ifndef(C2S26000_PB_H).
-define(C2S26000_PB_H, true).
-record(c2s26000, {
    type = erlang:error({required, type}),
    size = erlang:error({required, size}),
    page = erlang:error({required, page}),
    is_cross = erlang:error({required, is_cross})
}).
-endif.

-ifndef(S2C26000_PB_H).
-define(S2C26000_PB_H, true).
-record(s2c26000, {
    page = erlang:error({required, page}),
    list = []
}).
...
-record(p_rank, {
    ...
    value2 = erlang:error({required, value2}),
    value3 = erlang:error({required, value3}),
    user = erlang:error({required, user})
}).
-endif.

-ifndef(C2S26002_PB_H).
-define(C2S26002_PB_H, true).
-record(c2s26002, {
    is_cross = erlang:error({required, is_cross})
}).
-endif.

-ifndef(S2C26002_PB_H).
-define(S2C26002_PB_H, true).
-record(s2c26002, {
    list = []
}).
-endif.

-ifndef(C2S26003_PB_H).
-define(C2S26003_PB_H, true).
-record(c2s26003, {
    
}).
-endif.

-ifndef(S2C26003_PB_H).
-define(S2C26003_PB_H, true).
-record(s2c26003, {
    list = []
}).
-endif.

-ifndef(P_FAMOUS_PB_H).
-define(P_FAMOUS_PB_H, true).
-record(p_famous, {
    user_id = erlang:error({required, user_id}),
    user = erlang:error({required, user})
}).
