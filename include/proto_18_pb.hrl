...
-ifndef(C2S18001_PB_H).
-define(C2S18001_PB_H, true).
-record(c2s18001, {
    seq = erlang:error({required, seq})
}).
-endif.

-ifndef(C2S18002_PB_H).
-define(C2S18002_PB_H, true).
-record(c2s18002, {
    item_inst_id = erlang:error({required, item_inst_id}),
    bind = erlang:error({required, bind})
}).
-endif.

-ifndef(S2C18002_PB_H).
-define(S2C18002_PB_H, true).
-record(s2c18002, {
    item_inst_id = erlang:error({required, item_inst_id}),
...
-ifndef(C2S18003_PB_H).
-define(C2S18003_PB_H, true).
-record(c2s18003, {
    item_inst_id = erlang:error({required, item_inst_id}),
    bind = erlang:error({required, bind})
}).
...
-ifndef(S2C18003_PB_H).
-define(S2C18003_PB_H, true).
-record(s2c18003, {
    item_inst_id = erlang:error({required, item_inst_id}),
    result = erlang:error({required, result})
}).
...
-ifndef(C2S18004_PB_H).
-define(C2S18004_PB_H, true).
-record(c2s18004, {
...
-ifndef(S2C18004_PB_H).
-define(S2C18004_PB_H, true).
-record(s2c18004, {
    list = []
}).
-endif.

-ifndef(S2C18101_PB_H).
-define(S2C18101_PB_H, true).
-record(s2c18101, {
    list = []
}).
-endif.

-ifndef(C2S18102_PB_H).
-define(C2S18102_PB_H, true).
-record(c2s18102, {
    skill_id = erlang:error({required, skill_id}),
    one_key = erlang:error({required, one_key})
}).
-endif.

-ifndef(C2S18103_PB_H).
-define(C2S18103_PB_H, true).
-record(c2s18103, {
    skill_group_id = erlang:error({required, skill_group_id}),
    one_key = erlang:error({required, one_key})
}).
-endif.

-ifndef(C2S18104_PB_H).
-define(C2S18104_PB_H, true).
-record(c2s18104, {
    runeword_id = erlang:error({required, runeword_id}),
    one_key = erlang:error({required, one_key})
}).
-endif.

-ifndef(C2S18201_PB_H).
-define(C2S18201_PB_H, true).
-record(c2s18201, {
    type = erlang:error({required, type})
}).
-endif.

-ifndef(S2C18201_PB_H).
-define(S2C18201_PB_H, true).
-record(s2c18201, {
    id_list = []
}).
-endif.

-ifndef(C2S18301_PB_H).
-define(C2S18301_PB_H, true).
-record(c2s18301, {
    passive_skill_id = erlang:error({required, passive_skill_id})
}).
-endif.

-ifndef(S2C18401_PB_H).
-define(S2C18401_PB_H, true).
-record(s2c18401, {
    list = []
}).
-endif.

-ifndef(S2C18004_ITEM_PB_H).
-define(S2C18004_ITEM_PB_H, true).
-record(s2c18004_item, {
    item_tpl_id = erlang:error({required, item_tpl_id}),
    bind = erlang:error({required, bind})
}).
-endif.

-ifndef(S2C18401_SKILL_CD_PB_H).
-define(S2C18401_SKILL_CD_PB_H, true).
-record(s2c18401_skill_cd, {
    skill_id = erlang:error({required, skill_id}),
    next_time = erlang:error({required, next_time})
}).
-endif.
