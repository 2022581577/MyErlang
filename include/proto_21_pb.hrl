...
-ifndef(S2C21000_PB_H).
-define(S2C21000_PB_H, true).
-record(s2c21000, {
    vestment_list = []
}).
-endif.

-ifndef(C2S21001_PB_H).
-define(C2S21001_PB_H, true).
-record(c2s21001, {
    star = erlang:error({required, star}),
    type = 1
}).
...
-ifndef(S2C21001_PB_H).
-define(S2C21001_PB_H, true).
-record(s2c21001, {
...
-ifndef(C2S21002_PB_H).
-define(C2S21002_PB_H, true).
-record(c2s21002, {
    select = erlang:error({required, select})
}).
-endif.

-ifndef(S2C21002_PB_H).
-define(S2C21002_PB_H, true).
-record(s2c21002, {
    select = erlang:error({required, select})
}).
-endif.

-ifndef(C2S21003_PB_H).
-define(C2S21003_PB_H, true).
-record(c2s21003, {
    vestment_id = erlang:error({required, vestment_id}),
...
-ifndef(S2C21003_PB_H).
-define(S2C21003_PB_H, true).
-record(s2c21003, {
    vestment_id = erlang:error({required, vestment_id}),
    result = erlang:error({required, result}),
    bless_add = erlang:error({required, bless_add})
}).
-endif.

-ifndef(S2C21004_PB_H).
-define(S2C21004_PB_H, true).
-record(s2c21004, {
    vestment_id = erlang:error({required, vestment_id}),
    element_list = []
}).
...
-ifndef(C2S21005_PB_H).
-define(C2S21005_PB_H, true).
-record(c2s21005, {
    vestment_id = erlang:error({required, vestment_id})
}).
-endif.

-ifndef(S2C21005_PB_H).
-define(S2C21005_PB_H, true).
-record(s2c21005, {
    vestment_id = erlang:error({required, vestment_id}),
    level = erlang:error({required, level})
}).
...
-ifndef(C2S21006_PB_H).
-define(C2S21006_PB_H, true).
-record(c2s21006, {
    item_id = erlang:error({required, item_id}),
...
-ifndef(S2C21006_PB_H).
-define(S2C21006_PB_H, true).
-record(s2c21006, {
    item_id = erlang:error({required, item_id}),
    list = []
}).
...
-ifndef(XILIAN_STRUCT_PB_H).
-define(XILIAN_STRUCT_PB_H, true).
-record(xilian_struct, {
    select = erlang:error({required, select}),
    attr_list = []
}).
-endif.

-ifndef(C2S21007_PB_H).
-define(C2S21007_PB_H, true).
-record(c2s21007, {
    item_id = erlang:error({required, item_id}),
    select = erlang:error({required, select})
}).
...
-ifndef(S2C21007_PB_H).
-define(S2C21007_PB_H, true).
-record(s2c21007, {
    result = erlang:error({required, result})
}).
-endif.

-ifndef(C2S21008_PB_H).
-define(C2S21008_PB_H, true).
-record(c2s21008, {
    item_id_list = []
}).
-endif.

-ifndef(C2S21009_PB_H).
-define(C2S21009_PB_H, true).
-record(c2s21009, {
    vestment_id = erlang:error({required, vestment_id}),
    tpl_id = erlang:error({required, tpl_id})
}).
...
-ifndef(S2C21009_PB_H).
-define(S2C21009_PB_H, true).
-record(s2c21009, {
    vestment_id = erlang:error({required, vestment_id}),
    tpl_id = erlang:error({required, tpl_id}),
    next_tpl_id = erlang:error({required, next_tpl_id})
}).
-endif.
